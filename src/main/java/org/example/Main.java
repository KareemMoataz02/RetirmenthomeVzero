...
public class Main {
    public static void main(String[] args) {
        // Create a new volunteer and add them to the database
        Volunteer volunteer = new Volunteer(new User(101));
        boolean volunteerCreated = volunteer.createVolunteer("Jane Smith", 25);
        System.out.println("Volunteer Created: " + volunteerCreated);

        // Now the volunteer can make reservations
        boolean reservationCreated = volunteer.makeReservation(1); // Assuming eventId is 1
